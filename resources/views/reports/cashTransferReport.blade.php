...
<body>
    ...
    <div style="width:700px; margin:0px auto 30px auto; border:1px solid #949494; font-family: Arial, Helvetica, sans-serif;">
        <h2 style="font-weight:400; font-size:16px; text-align:center; padding:8px 0 10px 0;">Cash Transfer Report</h2>
        <table style="width: 700px; padding:5px;">
            ...
            <tr>
                <td style="display:inline-block; font-size: 10px; width:100%; color:#5f5959;">
                    <span>Account Name: {{$account_name}}</span>
    ...
    <table table style="width:700px;font-size: 10px; margin:0 auto 0 auto; border:1px solid  #949494; border-collapse:collapse; font-family: Arial, Helvetica, sans-serif;">
        <thead style="width:700px;">
            <tr style="background-color: #5e5c5c; width:100%; color:white">
                <th style="padding:4px 4px 4px 15px; font-weight:normal; text-align:left;">Date</th>
                <th style="padding-left:15px; text-align:left; font-weight:normal;" colspan="2"> Particulars</th>
                <th style="padding:4px 4px 4px 0; font-weight:normal;">From</th>
                <th style="padding:4px 4px 4px 0; font-weight:normal;">To</th>
                <th style="padding:4px 4px 4px 0; font-weight:normal;">Balance</th>
            </tr>
        </thead>
        <tbody>
        @foreach ($data as $item )
            <tr style="width: 100%; font-size: 10px; color:#5f5959;">
                ...
                <td style="text-align:center; padding:4px 4px 4px 0">{{$item['from']}} </td>
                <td style="text-align:center; padding:4px 4px 4px 0">{{$item['to']}}  </td>
                <td style="text-align:center; padding:4px 4px 4px 0">{{$item['amount']}}</td>
            </tr>
            @endforeach
    ...
    <!-- <div style="width:700px; margin:30px auto; font-family: Arial, Helvetica, sans-serif;">
        <div style="width: 300px; float:left; font-weight:500; margin-right:35px">
            <h2 style="margin-bottom: 15px; font-size: 12px; font-weight:400;">Total Debit Amount  :&nbsp; 12,000,000 BDT</h2>
            <h2 style="margin-bottom: 15px; font-size: 12px; font-weight:400;">Total Credit Amount   :&nbsp; 12,000,000 BDT</h2>
        </div>

        <div style="width: 300px; float:left; font-weight:400;">
            <h2 style="margin-bottom: 15px; font-size: 12px; font-weight:400;">Opening Balance :&nbsp; 0.00 BDT</h2>
            <h2 style="margin-bottom: 15px; font-size: 12px; font-weight:400;">Outstanding :&nbsp; 0.00 BDT</h2>
        </div>
    </div> -->
</body>
</html>
