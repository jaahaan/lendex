...
<body>
    ...
    <div style="width:700px; margin:15px auto 0 auto; border:1px solid #949494; font-family: Arial, Helvetica, sans-serif;">
        <h2 style="font-weight:400; font-size:16px; text-align:center; padding:8px 0 10px 0;  font-family: Arial, Helvetica, sans-serif;">Purchase Report</h2>
        <table style="width: 700px; padding:5px;">
            <tr>
                <td style="display:inline-block; font-size: 10px; width:100%;  font-family: Arial, Helvetica, sans-serif;">
                    <span style="display:inline-block;  color:#5f5959;">Total Purchase Amount : {{$total}}</span>
    ...
    <div style="width: 700px; margin:30px auto 60px auto; font-family: Arial, Helvetica, sans-serif;">
        ...
        <table table style="width:700px;font-size: 10px; margin:10px auto 0 auto; border:1px solid  #949494; border-collapse:collapse; font-family: Arial, Helvetica, sans-serif;">
            ...
            <tbody>
                ...
                <tr style="width: 100%; font-size: 10px; color:#3c3636; ">
                    ...
                    <td  style="padding: 4px 4px 4px 0; margin-right:5px; width:100px;">{{$purchase['product']['unit']}}</td>
                    <td style="text-align:left; width:110px; padding:4px 4px 4px 0; width:100px;">{{$purchase['unitPrice']}} </td>
                    <td style="text-align:left; width:110px; padding:4px 4px 4px 0; width:120px;">{{$purchase['quantity'] * $purchase['unitPrice']}}  </td>
                </tr>
                @endforeach
            </tbody>
        </table>
