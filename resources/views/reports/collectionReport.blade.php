...
<body>
    ...
    <div style="width:700px; margin:0px auto 0 auto; border:1px solid #949494; font-family: Arial, Helvetica, sans-serif;">
        <h2 style="font-weight:400; font-size:16px; text-align:center; padding:8px 0 10px 0;">Collection Report</h2>
        <table style="width: 700px; padding:5px;">
            ...
            <tr>
                <td style="display:inline-block; font-size: 10px; width:100%; color:#5f5959;">
                    <span>Account Name: @if ($account >0)
                        {{$data[0]['account']['account_name']}}
                        @else All Account
                    @endif</span>
    ...
    <table table style="width:700px;font-size: 10px; margin:30px auto 0 auto; border:1px solid  #949494; border-collapse:collapse; font-family: Arial, Helvetica, sans-serif;">
        ...
        <tbody>
            ...
            @endforeach
            <!-- <tr style="width: 100%; font-size: 10px; color:#5f5959;">
                <td style="text-align:center; width:80px; padding:4px 4px 4px 4px;">Date</td>
                <td colspan="2" style="padding: 4px 4px 4px 15px; margin-right:5px; width:170px;">Particulars</td>
                <td style="text-align:left; width:110px; padding:4px 4px 4px 0;">Particulars </td>
                <td style="text-align:left; width:110px; padding:4px 4px 4px 0;">Particulars </td>
                <td style="text-align:left; width:110px; padding:4px 4px 4px 0;">Debit</td>
                <td style="text-align:left; width:110px; padding:4px 4px 4px 0;">Credit</td>
            </tr>
            <tr style="width: 100%; font-size: 10px; color:#5f5959;">
                <td style="text-align:center; width:80px; padding:4px 4px 4px 4px;">Date</td>
                <td colspan="2" style="padding: 4px 4px 4px 15px; margin-right:5px; width:170px;">Particulars</td>
    ...
    <div style="width:700px; margin:30px auto; font-family: Arial, Helvetica, sans-serif;">
        <div style="width: 300px; float:left; font-weight:500; margin-right:35px">
            <h2 style="margin-bottom: 15px; font-size: 12px; font-weight:400;">Total Collection Amount :&nbsp; {{$total}} BDT</h2>
        </div>
