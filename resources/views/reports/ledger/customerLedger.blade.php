...
<body>
    ...
    <div style="width:700px; margin:0px auto 30px auto; border:1px solid #949494; font-family: Arial, Helvetica, sans-serif;">
        <h2 style="font-weight:400; font-size:18px; text-align:center; padding:7px;">Customer Ladger Report</h2>
        <table style="width:700px; padding:5px;">
            <tr>
                <td style="display:inline-block; font-size: 10px; width:100%;">
                    <span style="display:inline-block; width: 500px; color:#5f5959;">Customer Name: {{$customer['customerName']}}</span>
                    <span style="width: 300px; float: right; margin-right:20px;"></span>
                </td>
            </tr>
            <tr>
                <td style="display:inline-block; font-size: 10px; width:100%;">
                    <span style="display:inline-block; width: 500px; color:#5f5959;">Address: {{$customer['address']}} </span>
                    <span style="width: 300px; float: right; margin-right:20px;"></span>
                </td>
            </tr>
            <tr>
                <td style="display:inline-block; font-size: 10px; width:100%; color:#5f5959;">
                    <span>Mobile: {{$customer['contact']}} </span>
    ...
    <table table style="width:700px;font-size: 10px; margin:40px auto 30px auto; border:1px solid  #949494; border-collapse:collapse; font-family: Arial, Helvetica, sans-serif;">
        <thead style="width:700px;">
            <tr style="background-color: #5e5c5c; width:100%; color:white">
                <th style="padding:4px 4px 4px 15px; text-align:left; font-weight:normal;">Date</th>
                <th style="padding-left:15px; text-align:left; font-weight:normal;" colspan="2"> Particulars</th>
                <th style="padding:4px 4px 4px 0; font-weight:normal;">Debit</th>
                <th style="padding:4px 4px 4px 0; font-weight:normal;">Credit</th>
        ...
        <tbody>
            @foreach ($data as $item )
                <tr style="width: 100%; font-size: 10px; color:#5f5959;">
                    ...
                    <td colspan="2" style="padding: 4px 4px 4px 15px; margin-right:5px;">
                        {{$item['particulars']}}
                    </td>
