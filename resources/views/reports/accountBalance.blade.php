...
<body>
    ...
    <div style="width:700px; margin:0px auto 30px auto; border:1px solid #949494; font-family: Arial, Helvetica, sans-serif;">
        <h2 style="font-weight:400; font-size:16px; text-align:center; padding:8px 0 10px 0;">Cash Balance</h2>
    </div>
    ...
    <table table style="width:700px;font-size: 10px; margin:30px auto 0 auto; border:1px solid  #949494; border-collapse:collapse; font-family: Arial, Helvetica, sans-serif;">
        <thead style="width:700px;">
            <tr style="background-color: #5e5c5c; width:100%; color:white">
                <th style="padding:4px 4px 4px 15px; font-weight:normal; text-align:left;">Account Name</th>
                <th style="padding:4px 4px 4px 0; font-weight:normal;">Branch Name</th>
        ...
        @foreach ($data as $item )
            <tr style="width: 100%; font-size: 10px; color:#5f5959;">
                <td style="text-align:left; padding:4px 4px 4px 15px; width:100px; " >{{$item['account_name']}}</td>
                <td style="text-align:center; padding:4px 4px 4px 0">{{$item['branch_name']}}  </td>
