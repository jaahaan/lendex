...
<body>
    ...
    <div style="width:700px; margin:15px auto 0 auto; border:1px solid #949494; font-family: Arial, Helvetica, sans-serif;">
        <h2 style="font-weight:400; font-size:16px; text-align:center; padding:8px 0 10px 0;  font-family: Arial, Helvetica, sans-serif;">Exchange Report</h2>
        <table style="width: 700px; padding:5px;">
            <tr>
                <td style="display:inline-block; font-size: 10px; width:100%;  font-family: Arial, Helvetica, sans-serif;">
                    <span style="display:inline-block;  color:#5f5959;">Total Exchange Amount : {{ $total }} BDT</span>
        ...
        <table table style="width:700px;font-size: 10px; margin:10px auto 0 auto; border:1px solid  #949494; border-collapse:collapse; font-family: Arial, Helvetica, sans-serif;">
            <thead style="width:700px;">
                <tr style="background-color: #706e6e; width:700px; color:white">
                    ...
                    <th style="padding:4px 4px 4px 0; text-align:left; font-weight:normal; width:100px;"> Exchange Unit</th>
                    <th style="padding:4px 4px 4px 0;text-align:left; font-weight:normal; width:100px;">Unit Price</th>
                    <th style="padding:4px 4px 4px 0;text-align:left; font-weight:normal; width:120px;">Total Exchange Price</th>
                </tr>
            </thead>
            <tbody>
                @foreach ( $item['exchangelist'] as $exchangelist )
                    <tr style="width: 100%; font-size: 10px; color:#3c3636; margin-bottom: -2px;">
                        <td style="text-align:left; padding:4px 4px 4px 20px;" colspan="4">{{ $exchangelist['product']['productName'] }}</td>
                        <td  style="padding: 4px 4px 4px 0; margin-right:5px; width:100px;">{{ $exchangelist['product']['unit'] }}</td>
                        <td style="text-align:left; width:110px; padding:4px 4px 4px 0; width:100px;">{{ $exchangelist['sellingPrice'] }}</td>
                        <td style="text-align:left; width:110px; padding:4px 4px 4px 0; width:120px;">{{ $exchangelist['quantity'] * $exchangelist['sellingPrice']}}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
