            ...
            <div class="col-12 col-md-6 col-lg-5 login_page_main_all">
                ...
                <div class="login_page_main">
                  ...
                  <!--   <p class="login_page_main_title text_center">SIGN IN</p> -->
                    <div class="card-body">
                        <form method="POST" action="{{ url('/reset-password') }}" aria-label="{{ __('Login') }}">
                            @csrf
                            ...
                            <div class="form-group input_group">
                                 ...
                                 <div class="input_group_input">
                                     <input id="password_confirmation" type="password" placeholder="Confirm Password" class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" name="password_confirmation" required>
