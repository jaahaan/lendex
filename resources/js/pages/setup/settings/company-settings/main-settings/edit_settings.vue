    ...
    methods: {
        ...
        async settingSave() {
            ...
            if (
                ...
                validation = false;
                this.errorMessages.referenceBonus =
                    "Reference Bonus is required!";
            }
            if (
            ...
            if (this.formValue.supportContact == "") {
                validation = false;
                this.errorMessages.supportContact =
            ...
            if (response.status == 200) {
                this.s(
                    "Great!",
                    "Settings information has been added successfully!"
                );
                setTimeout(() => {
