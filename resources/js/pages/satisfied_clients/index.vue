                ...
                <Col span="24">
                    <Form ref="formInline" inline>
                        ...
                        <FormItem>
                            <Button
                                type="primary"
                                @click="$router.push('/add_satisfied_clients')"
                            >
...
export default {
    ...
    methods: {
        showEdit(index) {
            this.$router.push(
                `/edit_satisfied_clients/${this.data1[index].id}`
            );
        },
        showRemove(index) {
        ...
        async getSatisfiedClients() {
            ...
            const response = await this.callApi(
                "get",
                `/app/get_satisfied_clients?search=${this.search}`
            );
            if (response.status == 200) {
